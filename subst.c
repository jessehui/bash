     ...
     int open_for_read_in_child;
{
  ...
  save_pipeline (1);
    ...
    // pid = make_child_without_fork_for_subst2(string, FORK_ASYNC,
     ...
     int flags;
{
  ...
  pid = make_child_without_fork("cmd_subst", string, fork_flags | FORK_NOTERM,
                      fildes[0], fildes[1], NULL, NULL);
  // pid = make_child_without_fork_for_subst2( string, fork_flags | FORK_NOTERM,
  //                     fildes[0], fildes[1]);
