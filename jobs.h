...
extern pthread_t make_child_without_fork_simple_cmd PARAMS((char *, int, int, int,
        SIMPLE_COM *));
...
extern pid_t make_child_without_fork_for_process_subst PARAMS((char *, int, int, int,
        int));
